...
def cad2020_cra():
    ...
    if install_from_png(app_name="CAD2020", confidence=0.8, sleep_time_list=sleep_time, grayscale_list=grayscale,
            ...
            if install_from_png(app_name="CAD2020", confidence=0.8, sleep_time_list=sleep_time, grayscale_list=grayscale,
                ...
                coordinate_list = install_from_png(app_name="CAD2020", confidence=0.8, sleep_time_list=sleep_time,
                ...
                if len(coordinate_list) == 2:
                    ...
                    key_soft = Application().start(join(getcwd(), 'app_pkg', 'CAD2020', 'crack', 'crack.exe'))  # 打开注册机
